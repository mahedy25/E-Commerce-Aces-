      ...
      <div className='flex justify-end my-20'>
        ...
        <div className='w-full sm:w-[450px]'>
           ...
           <div className='w-full text-end'>
            <button onClick={()=>navigate('/place-order')} className='bg-black text-white hover:bg-cyan-500 hover:text-black active:text-black active:bg-cyan-300 px-8 py-3 text-sm mt-5 font-sans font-bold rounded-md'>Proceed To Checkout</button>
           </div>
        </div>
      </div>
    </div>
